...
void screen_show_logo() {
    ...
    uint8_t x = (display->getWidth() - HNT_IMAGE_WIDTH) / 2;
    uint8_t y = SCREEN_HEADER_HEIGHT + (display->getHeight() - SCREEN_HEADER_HEIGHT - HNT_IMAGE_HEIGHT) / 2 + 1;
    display->drawFastImage(x, y, HNT_IMAGE_WIDTH, HNT_IMAGE_HEIGHT, HNT_IMAGE);
}
